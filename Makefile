...
SOURCES = \
	__init__.py \
	cria_memorial.py cria_memorial_dialog.py

PLUGINNAME = cria_memorial

PY_FILES = \
	__init__.py \
	cria_memorial.py cria_memorial_dialog.py

UI_FILES = cria_memorial_dialog_base.ui
...
QGISDIR=C:\Users\edu_s\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
