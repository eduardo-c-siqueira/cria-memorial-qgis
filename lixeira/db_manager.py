...
class DataBaseManager:
    ...
    def getMemorialPadraoBase(self, reference) -> MemorialPadraoBase | None:
        #TODO: implementar
        return None

    def getMemorialPadraoLoteamento(self, reference) -> MemorialPadraoLoteamento | None:
        #TODO: implementar
        return None