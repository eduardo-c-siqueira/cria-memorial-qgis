...
__author__ = 'eduardo.edu28@gmail.com'
__date__ = '2026-07-30'
__copyright__ = 'Copyright 2026, Eduardo C. Siqueira'
...
class CriaMemorialDialogTest(unittest.TestCase):
    """Test dialog works."""

    def setUp(self):
        """Runs before each test."""
        self.dialog = CriaMemorialDialog(None)
...
if __name__ == "__main__":
    suite = unittest.makeSuite(CriaMemorialDialogTest)
